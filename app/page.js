      ...
      <div className="max-w-5xl mx-auto">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-baseline mb-12 border-b border-zinc-900 pb-8 gap-6">
          <div>
            <h1 className="text-2xl font-bold text-white tracking-[0.2em]">
              STAT_ARB <span className="text-zinc-600">// EXECUTION_CORE</span>
            </h1>
            ...
            <div className="flex gap-4 mt-3 text-[10px] tracking-widest text-zinc-500">
              <span>
                GOVERNOR_STATE:{" "}
                <span
                  className={`font-bold ${getRegimeColor(
        ...
        <div className="space-y-4">
          {engineData.executions &&
            engineData.executions.map((trade, i) => (
              <div
                key={i}
              ...
              >
                <div className="flex justify-between items-start mb-6">
                  <div>
                    <div className="text-xl font-bold text-white tracking-widest mb-1">
                      {trade.basket}
                    </div>
                    ...
                    <div className="flex gap-3 items-center">
                      ...
                      <span className="text-[10px] text-zinc-500 tracking-[0.1em]">
                        TRADE_SCORE: {Number(trade.score).toFixed(1)}
                      </span>
                    </div>
                  </div>
